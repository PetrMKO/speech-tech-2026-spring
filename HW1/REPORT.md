...
# Conclusion
Мне понравилось влияние n_groups на результат, accuracy выросло, время обучения не изменилось, количество вычислений упало, как и число параметров. Время обучения, мне кажется, упало не значимо, потому что я считал в google collab и это может быть максимальное время, которое можно выжать. Но уменьшение количество flops точно скажется на бОльших моделях. 